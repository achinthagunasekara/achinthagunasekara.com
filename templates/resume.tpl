<div class="content-wrapper-non-main-page">
	...
	<div class="content">
		...
		<div class="pure-u-1-4"><!-- Space Holder --></div>
			...
			<p>Engineering Industry – Melbourne<br/>
			(December 2014 - August 2015)</p>
			<p>Absolute Manage, Apache, C#, Dell EMC, Docker, ELK (Elasticsearch and Kibana), Hyper-V, IIS, Java, Linux, Logstash, Mac, MongoDB, MySQL, Nagios, .NET, NetApp, PHP, Puppet, Splunk, VMware, Windows Server, Winodws</p>
			<h4><i class="fa fa-phone"></i>&nbsp;&nbsp;&nbsp;Implementations Engineer</h4>
			<p>Telecommunications Industry – Melbourne<br/>
			(May 2013 – December 2014)</p>
			<p>Apache, Aspect Unified IP, C#, Chef, F5, IIS, ITIL, Java, Linux, Microsoft SQL Server, .NET, Nginx, PHP, RabbitMQ, RIAK, Telephony, VMware, Windows, Windows Server</p>
			<h4><i class="fa fa-truck"></i>&nbsp;&nbsp;&nbsp;Developer/Network Engineer</h4>
			<p>Transport and Logistics Industry – Melbourne<br/>
			(February 2009 – May 2013)</p>
                	<p>Apache, C#, Java, Microsoft SQL Server, MySQL, .NET, PHP, Samba, Tomcat, VMware, Windows, Windows Mobile, Winodws Server</p>
		</div>
	</div>
	...
	<div class="content">
                ...
                <div class="pure-u-1-2">
			<h4>
				<img src="https://images.credly.com/size/680x680/images/8e968853-15af-4bbc-9d03-cf518971909c/AWS-SolArchitect-Professional-2020.png" alt="AWS Certified Solutions Architect Professional" width="25" height="25">
				&nbsp;&nbsp;&nbsp;AWS Certified Solutions Architect – Professional Level
			</h4>
                        <p>Amazon Web Services</p>
			<h4>
				<img src="https://images.credly.com/size/680x680/images/7fbb805d-ea82-4276-a227-e63121a2844b/AWS-DevOpsEngineer-Professional-2020.png" alt="AWS Certified DevOps Engineer Professional" width="25" height="25">
				&nbsp;&nbsp;&nbsp;AWS Certified DevOps Engineer – Professional
			</h4>
                        <p>Amazon Web Services</p>
			<h4>
				<img src="https://images.credly.com/size/680x680/images/4bc21d8b-4afe-4fbd-9a90-a9de8bf7b240/AWS-SolArchitect-Associate-2020.png" alt="AWS Certified Solutions Architect Associate" width="25" height="25">
				&nbsp;&nbsp;&nbsp;AWS Certified Solutions Architect – Associate Level
			</h4>
                        <p>Amazon Web Services</p>
			<h4>
				<img src="https://images.credly.com/size/680x680/images/bf588058-87cc-4cbd-94b0-ef0385fb4371/AWS-SysOpAdmin-Associate-2020.png" alt="AWS Certified SysOps Administrator Associate" width="25" height="25">
				&nbsp;&nbsp;&nbsp;AWS Certified SysOps Administrator – Associate Level
			</h4>
                        <p>Amazon Web Services</p>
			<h4>
				<img src="https://images.credly.com/size/680x680/images/598f6ac6-2dbd-4394-8ae4-943b2f4c43ea/AWS-Developer-Associate-2020.png" alt="AWS Certified Developer Associate" width="25" height="25">
				</i>&nbsp;&nbsp;&nbsp;AWS Certified Developer Administrator – Associate Level
			</h4>
			<p>Amazon Web Services</p>
			<h4>
				<img src="https://images.credly.com/size/680x680/images/68468004-5a85-4f3b-bc58-590773979486/AWS-CloudPractitioner-2020.png" alt="AWS Certified Cloud Practitioner" width="25" height="25">
				&nbsp;&nbsp;&nbsp;AWS Certified Cloud Practitioner
			</h4>
                        <p>Amazon Web Services</p>
			<h4><i class="fa fa-cogs"></i>&nbsp;&nbsp;&nbsp;CCNA – Routing and Switching</h4>
                        <p>Cisco</p>
                        <h4><i class="fa fa-cogs"></i>&nbsp;&nbsp;&nbsp;CCENT – Routing and Switching</h4>
                        <p>Cisco</p>
                        <h4><i class="fa fa-cogs"></i>&nbsp;&nbsp;&nbsp;Google Apps Certified Administrator</h4>
                        <p>Google Certifications</p>
                        <h4><i class="fa fa-cogs"></i>&nbsp;&nbsp;&nbsp;Testing of Electrical Equipment Certificate</h4>
                        <p>Kangan Batman TAFE, VIC, Australia</P>
                </div>
        </div>
